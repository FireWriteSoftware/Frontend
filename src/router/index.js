...
import Permissions from '../views/permissions/Main'
import Bans from '../views/bans/Main'
import Ban from '../views/ban/Main'
import Reports from '../views/reports/Main'
import Tags from '../views/tags/Main'
import Badges from '../views/badges/Main'
import PostAuthorization from '../views/post-authorization/Main'
