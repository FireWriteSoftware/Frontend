  ...
  <div>
    ...
    <div class="col-span-12 grid grid-cols-12 gap-6 mt-8">
      ...
      <div class="col-span-12 lg:col-span-4 intro-y">
        ...
        <div class='bg-red-700 p-4 mb-4 rounded' v-if='!post.expires_at || this.is_expired(post.expires_at)'>
...
export default defineComponent({
  ...
  methods: {
    ...
    is_expired(timeString) {
      return Date.parse(timeString) - Date.now() < 0
    }
  }
})
</script>
